              ...
              <div className="row ">
                ...
                <div className="row my-1 d-flex justify-content-center">
                  <div className="col-md-12 ">
                    ...
                    <tbody>
                      <tr>
                        <td rowSpan={3}><img className='black-border ' src={`https://www.bitcoinqrcodemaker.com/api/?style=bitcoin&address=${this.state.address}`} alt="bitcoin QR code generator" height="200" width="225" /></td>
                        <td>Balance: </td>
                        <td>{(this.state.walletData.chain_stats.funded_txo_sum - this.state.walletData.chain_stats.spent_txo_sum) / 100000000} BTC</td>
                      </tr>
                        <tr>
                          <td>Value</td>
                          <td>$ {((this.state.walletData.chain_stats.funded_txo_sum - this.state.walletData.chain_stats.spent_txo_sum) / 100000000 * (this.state.price)).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                        </tr>
                        <tr>
                          <td>Number of Transactions</td>
                          <td>{this.state.walletData.chain_stats.tx_count}</td>
                        </tr>
                    </tbody>
                  </table>
                </div>
